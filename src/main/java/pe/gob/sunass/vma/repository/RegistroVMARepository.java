...
public interface RegistroVMARepository  extends JpaRepository<RegistroVMA, Integer>{
	...
	public Optional<RegistroVMA> findByIdItem(Integer idRegistroVma, Integer idEmpresa);  //es un metodo similar al anterior, para tener los registros segun el idEmpresa, del usuario en sesion.
	...
	@Query(value = "SELECT CASE " +
	 ...
	 public boolean isRegistroCompletado(@Param("idEmpresa") Integer idEmpresa); //para deshabilitar o habilitar el boton de Registrar para VMA
