...
public class EmpresaAssembler {
	...
	public static EmpresaDTO buildDtoModel(Empresa empresa) {
		...
		if (empresa != null) {
			...
			dto.setUpdatedAt(empresa.getUpdatedAt() == null ? null
					: DateUtil.format(Constants.Format.DateTime.DateTime, empresa.getUpdatedAt()));
		}
	...
	public static Page<EmpresaDTO> buildDtoModelCollection(Page<Empresa> pageEmpresa) throws Exception {
		...
		Page<EmpresaDTO> pageDTO = new PageImpl<EmpresaDTO>(listDTO, pageEmpresa.getPageable(),
