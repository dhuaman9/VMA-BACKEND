	        ...
	        return findAll((root, query, criteriaBuilder) -> {
	            ...
	            if (Objects.nonNull(filterDTO.getEmpresa()) && StringUtils.hasText(filterDTO.getEmpresa())) {
	                predicates.add(criteriaBuilder.like(
	                    criteriaBuilder.lower(root.get("empresa").get("nombre")),
	            ...
	            if (Objects.nonNull(filterDTO.getFechaDesde())) {
	                predicates.add(criteriaBuilder.greaterThanOrEqualTo(root.get("createdAt").as(LocalDate.class), filterDTO.getFechaDesde()));
	            }

	            if (Objects.nonNull(filterDTO.getFechaHasta())) {
	                predicates.add(criteriaBuilder.lessThanOrEqualTo(root.get("createdAt").as(LocalDate.class), filterDTO.getFechaHasta()));
	            }
